/*
Copyright 2016 The Kubernetes Auth Version 2.0 (the "License");
you may not use this file except ors.

Licensed under the Apache License,in compliance with the License.
